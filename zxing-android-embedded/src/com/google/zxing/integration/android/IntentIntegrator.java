...
public class IntentIntegrator {
    ...
    public final IntentIntegrator setContinuous(boolean continuous) {
        if (continuous) {
            addExtra(Intents.Scan.CONTINUOUS_MODE, true);
        }
        return this;
    }
     ...
     * init을 부르면 createSacnIntent를 통해 CaptureActivity를 호출
     *
     * @return the intent
     */
    public Intent createScanIntent() {
        ...
        /**
         * 해당하는 바코드 포맷을 String builder를 통해 ,를 주입하여 Extra에 넣어준다.
         */
